...
describe('date-input', function() {
  ...
  describe('.changed()', function() {
    ...
    it('should add a slash when I enter the day', function() {
    ...
    it('should add a slash when I enter the month', function() {
      ...
      assert.equal(event.value, '03/11/');
    ...
    it('should delete the digit to the left of a slash when I press backspace', function() {
      ...
      assert.equal(event.value, '03/11/984');
      assert.equal(event.selectionStart, 4);
      assert.equal(event.selectionEnd, 4);
